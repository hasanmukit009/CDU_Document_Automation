...
namespace DMS.Web.Data.Migrations
{
    ...
    [Migration("20210117130707_AddAssignedCourseCoordinatorToUnitInformationModel")]
    partial class AddAssignedCourseCoordinatorToUnitInformationModel
    {
            ...
            modelBuilder.Entity("DMS.Web.Models.UnitInformationModel", b =>
                {
                    ...
                    b.Property<string>("ChangeReuqest")
                        .HasColumnType("nvarchar(max)");
